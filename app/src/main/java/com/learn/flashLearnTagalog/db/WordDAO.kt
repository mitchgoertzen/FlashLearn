...
import com.learn.flashLearnTagalog.di.AppModule_LessonFilterPracticeCompletedFactory
...
interface WordDAO {
    ...
    @Query("UPDATE word_table SET type = :newType, tagalog = :newTagalog, english = :newEnglish " +
    ...
    @Query("UPDATE lesson_table SET title = :newTitle, imageID = :newImageID, level = :newLevel " +
