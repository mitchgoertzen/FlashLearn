...
//
//    val unlockedNullOrEmpty: Boolean get() = (mutableUnlocked.value == null) || mutableUnlocked.value!!.isEmpty()
//
//    fun initializeLists() {
//        mutablePracticedWords.value = mutableMapOf()
//        mutableViewed.value = mutableListOf()
...
//        Log.d(ContentValues.TAG, "size: ${mutableUnlocked.value!!.size}")
//        JsonUtility.writeJSON(
//            activity,
...
//    }
//
//    fun setPracticedList(activity: Activity, lessons: MutableList<String>) {
//        mutablePracticed.value = lessons
//        JsonUtility.writeJSON(
//            activity,
...
//
//
//    fun setPassedList(activity: Activity, lessons: MutableList<String>) {
//        mutablePassed.value = lessons
//        JsonUtility.writeJSON(
//            activity,
//            "passedLessons.json",
//            mutablePassed.value!!
